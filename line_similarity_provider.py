...
from .line_similarity_algorithm import LineSimilarityAlgorithm


class LineSimilarityProvider(QgsProcessingProvider):
    ...
    def loadAlgorithms(self):
        ...
        """
        self.addAlgorithm(LineSimilarityAlgorithm())
